...
var bgwhite = Colors.white.withOpacity(0.95);
const purple = Color.fromRGBO(46, 41, 78, 1);
...
const red = Color.fromRGBO(255, 115, 115, 1);
const green = Color.fromRGBO(52, 168, 83, 1);
